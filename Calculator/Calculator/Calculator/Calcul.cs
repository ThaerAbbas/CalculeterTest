           ...
           int action = Convert.ToInt32(Console.ReadLine());
            ...
            double result = 0;
             ...
             double[] input = new double[4];
                ...
                if (action == 3  )
                {
                    Console.WriteLine("Enter four numbers to addition and between each one press enter");
                ...
                {
                    Console.WriteLine("Enter four numbers to subtraction and between each one press enter");
                    for (int i = 0; i < input.Length; i++)
                    {
                        input[i] = Convert.ToInt32(Console.ReadLine());
                    }
